...
from .model import Habitacion, RobotLimpieza, Celda, Mueble, Charger

MAX_NUMBER_ROBOTS = 20
MAX_NUMBER_CHARGER = 10
...
model_params = {
    ...
    "num_baterias": mesa.visualization.Slider(
        "Número de Cargadores",
        4,
        2,
        MAX_NUMBER_CHARGER,
        1,
        description="Escoge cuantos carggadores quieres que hayan",
    ),
...
server = mesa.visualization.ModularServer(
    Habitacion, [grid, chart_celdas, chart_movimientos],
